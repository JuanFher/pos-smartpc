            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="signup-link register">¿Yá tiene una cuenta? <a href="{{ route('login') }}">Iniciar Sesión</a></p>
                        ...
                        <form class="text-left" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form">
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="name" name="name" type="text" value="{{ old('name') }}" class="form-control @error('email') is-invalid @enderror" placeholder="Ej. Juan Perez">
                                    @error('name')
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary" value="">Crear Cuenta</button>
                                    </div>
                                </div>
